...
?>
	...
	<!--	<div id="mw-navigation"> -->
			<h2 id="nav-msg"><?php $this->msg( 'navigation-heading' ) ?></h2> <!-- Accessibility invisible heading -->

	<!--		<div id="mw-head"> (this might be needed, search mw-head in dir if need. responsive use it, look at vector responsive. -->
				
			<!-- Left-nav is the Page and Discussion tabs which I have no fucking need for -->
				<!-- <div id="left-navigation">
					<?php /* $this->renderNavigation( [ 'NAMESPACES', 'VARIANTS' ] ); */ ?>
				</div> -->

				<!--Moved to be inside body-content  -->
					...
					?>" aria-labelledby="p-namespaces-label">
						...
						<ul<?php $this->html( 'userlangattributes' ) ?>>
							...
							foreach ( $this->data['namespace_urls'] as $link ) {
								?> <!-- Echo Page and discussion buttons / article and talk on <wikipedia></wikipedia> -->
				...
				case 'PERSONAL':
					...
					?>" aria-labelledby="p-personal-label">
						...
						<div class="user-menu">
							...
							// echo $this->makeListItem( "userpage", $personalTools["userpage"] );
		
							// echo '<li class="usermenu-profile"> <a href="/mediawiki/index.php/User:'. $userName . '" id="menulist-profile">My Profile</a> </li>';
							// echo $this->makeListItem( "preferences", $personalTools["preferences"] );
							// echo $this->makeListItem( "watchlist", $personalTools["watchlist"] );
							// echo $this->makeListItem( "mycontris", $personalTools["mycontris"] );
							// echo '<li class="usermenu-help"> <a href="/mediawiki/index.php/Help:Center">Help Center</a> </li>';
					...
					</div> <!-- p-personal div, ye the indenting of things above should be one tab more.. -->
					<?php
					break;
				case 'SEARCH':
					?>
...
// 	echo		$this->makeListItem( "contributions", $personalTools["contributions"] );
// 	echo		$this->makeListItem( "logout", $personalTools["logout"] );
// }
...
// debug_to_console( $elapsed );
// debug_to_console( $average );
...
// 		echo $this->makeListItem( $key, $item );
// 	}
// 	$this->makeListItem( "preferences", $personalTools["preferences"] );
// }
// $endTime = microtime(true);  
// $elapsed = $endTime - $startTime;
// $average = $elapsed / $tt;
